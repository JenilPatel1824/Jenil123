...
<div style="background-color:#a3939c; width:60%; position: relative;margin-left:26%; margin-top:5%; margin-bottom: 5%; padding:3%;"><br />
...
<tr>
<td><b>Signature :- </b></td>
<td>:<a href="download.php?file=<?php echo $dow_sign; ?>">Click here</a></td>
</tr>
<tr>
<td><b>Address :- </b></td>
...
<td><?php if($row['debit'] ==1 ) echo $row_1['type']; else echo 'Not Available'; ?></td>
</tr>
</table><br /><br /><form action="request_action.php" method="POST">
<center><input type="submit" class="btn btn-success" name="allow" value="Approve">
<input type="submit" class="btn btn-danger" name="deny" value="Reject"></center>
</form>
